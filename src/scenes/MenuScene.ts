...
export class MenuScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    const preview = this.add.sprite(318, streetY, 'player', 0).setOrigin(0.5, 1).setScale(1.2)
    preview.play('player-walk')
    const dogPreview = this.add.sprite(430, streetY, 'dog', 0).setOrigin(0.5, 1).setScale(1.35)
